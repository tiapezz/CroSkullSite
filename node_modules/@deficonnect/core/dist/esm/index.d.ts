import { IConnector, IConnectorOpts, ISessionStatus, ISessionError, IJsonRpcResponseSuccess, IJsonRpcResponseError, IJsonRpcRequest, ITxData, IClientMeta, IUpdateChainParams, IRequestOptions, IInternalRequestOptions, ICreateSessionOptions, IWalletConnectSessionWallet, IJsonRpcRequestSessionInfo } from "@deficonnect/types";
declare class Connector implements IConnector {
    ...
    set selectedWalletId(value: string);
    get selectedWalletId(): string;
    set wallets(value: IWalletConnectSessionWallet[]);
    get wallets(): IWalletConnectSessionWallet[];
